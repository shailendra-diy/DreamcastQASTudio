...
/**
 * Executes individual test steps against a WebDriver instance.
 */
public class StepRunner {

    private final WebDriver           driver;
    private final List<String>        runLog;
    private final BiConsumer<String, String> logFn; // (type, msg)
    ...
    /**
     * Runs a single step. Returns true = pass, false = fail.
     */
    public boolean run(TestStep step, int idx, String ssDir, boolean autoSS) {
        ...
        try {
            ...
            switch (action) {
                ...
                case "getAttribute": {
                    String attr = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)))
                        .getAttribute(value);
                    log("INFO", "   🏷 [" + value + "]: " + attr);
                    break;
                }
